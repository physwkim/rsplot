...
**CurvesROIWidget integration (main, not pushed):** ≈219 Done · ~102 open — the last open H row closed: per-curve ROI
...
## ROI system (creation, editing, manager, statistics)  — 24✅ 6◐ 0☐
