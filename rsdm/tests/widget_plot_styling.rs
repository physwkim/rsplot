...
use rsdm::widgets::{RsdmScatterPlot, RsdmTimePlot, RsdmWaveformPlot};
use rsplot::YAxis;
...
fn builders_style_the_underlying_plot() {
    ...
    let wf = RsdmWaveformPlot::new(&rs, 0)
        .with_title("Waveform")
        .with_x_label("Index")
        .with_y_label("Counts")
    ...
    let sc = RsdmScatterPlot::new(&rs, 2)
        .with_x_label("X")
