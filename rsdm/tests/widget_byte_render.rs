//! Headless wgpu readback of [`RsdmByteIndicator`]'s LED grid.
//!
...
use rsdm::widgets::RsdmByteIndicator;
use rsdm::{Engine, PvValue};
use rsplot::egui;

struct App {
    indicator: RsdmByteIndicator,
}
...
fn render(value: i64, num_bits: usize) -> Counts {
    ...
    let indicator = RsdmByteIndicator::new(&engine, "loc://byte_render?type=int&init=0")
        .expect("connect")
