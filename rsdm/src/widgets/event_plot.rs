//! `RsdmEventPlot` — scalar pairs extracted from an event array, accumulated as
//! XY markers.
//!
//! Ports `pydm/widgets/eventplot.py` (`PyDMEventPlot` + `EventPlotCurveItem`)
//! onto a `rsplot` [`Plot1D`] scatter item. Unlike
//! [`RsdmScatterPlot`](crate::widgets::RsdmScatterPlot) (which
...
use rsplot::{DataMargins, ItemHandle, Plot1D, PlotId, PlotResponse, Symbol, egui};
...
impl RsdmEventPlot {
    ...
    /// secondary axis ([`YAxis::Right`](rsplot::YAxis::Right) or an
