//! `RsdmScatterPlot` — paired scalar channels as accumulated XY markers.
//!
//! Ports `pydm/widgets/scatterplot.py` (`PyDMScatterPlot` +
//! `ScatterPlotCurveItem`) onto a `rsplot` [`Plot1D`] scatter item. Each curve
...
use rsplot::{DataMargins, ItemHandle, Plot1D, PlotId, PlotResponse, Symbol, YAxis, egui};
