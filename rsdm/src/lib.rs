//! `rsdm` — RsDM, a PyDM-style EPICS display layer for [`rsplot`].
//!
//! A Rust port of [PyDM](https://github.com/slaclab/pydm)'s core engine and
//! widgets (a PyQt EPICS display manager), built on top of `rsplot`'s
...
//!   `RsdmByteIndicator`, the time/waveform/scatter plots, the camera image
...
#[cfg(feature = "pva")]
pub use data_plugins::epics_plugins::pva_plugin::PvaPlugin;
